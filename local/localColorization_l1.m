function [ resImg ] = localColorization_l1( gImg, Obvs, mu, patPara)
...
for n = 1:patJmp:patNum
    ...
    for m = 1:patJmp
        ...
        [Data] = makeData(gupObv_m, gayPat_m, Omega_m);
        [newPat_m, ~, ~, iter(m)] = ColorizationLR(Data, 10, 10, 1e-7, 200);
...
%% ------------------------------------------------------------------------
function [Data] = makeData(gupObv, gayPat, Omega)
Data.Omega = Omega;
Data.D = gupObv;
Data.B = gayPat/3;
end